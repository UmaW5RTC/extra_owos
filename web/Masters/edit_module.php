...
<?php
  if(request_is_post() && request_is_same_domain()) {
    ...
    $message_type = "danger";
        ...
        $sel_module->imo_moduleiconname = $_POST['imo_moduleiconname'];
        $sel_module->imo_modulepagename = $_POST['imo_modulepagename'];
        $sel_module->imo_modulestatus = $_POST['imo_modulestatus'];
