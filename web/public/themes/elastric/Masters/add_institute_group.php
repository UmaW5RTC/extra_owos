...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Add Institute Group</strong></li>
</ol>
        ...
        <div class="neo-module-content">
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Institute Group Code" name="iig_institutegroupcode" required="required">
                ...
                <div class="form-group form-md-line-input">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="Institute Group Name" name="iig_institutegroupname" onkeydown="upperCaseF(this)" required="required">
                        <div class="form-control-focus"> </div>
