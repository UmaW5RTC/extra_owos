        ...
        <div class="neo-module-content">
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                                ...
                                                <label class="col-md-3 control-label" for="ist_countrycode">Country Code
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="State Code" name="ist_countrycode" value="<?php echo $sel_state->ist_countrycode; ?>" readonly>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="State Code" name="ist_statecode" value="<?php echo $sel_state->ist_statecode; ?>" readonly>
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="State Name" name="ist_statename" value="<?php echo $sel_state->ist_statename; ?>">
                                                    <div class="form-control-focus"> </div>
