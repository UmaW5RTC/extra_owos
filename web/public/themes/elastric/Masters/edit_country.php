            ...
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="icy_countrycode">Country Code
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Country Code" name="icy_countrycode" value="<?php echo $sel_country->icy_countrycode; ?>" readonly>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="icy_countryname">Country Name
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Country Name" name="icy_countryname" value="<?php echo $sel_country->icy_countryname; ?>">
                                                    <div class="form-control-focus"> </div>
