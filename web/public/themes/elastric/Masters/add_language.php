...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Add Language</strong></li>
</ol>
            ...
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="ilu_languagecode">Language Code
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" required="required" class="form-control" placeholder="Language Code" name="ilu_languagecode">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="ilu_languagename">Language Name
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <input type="text" required="required" class="form-control" placeholder="Language Name" name="ilu_languagename" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">Language Name</span>
                                                </div>
                                            </div>
                                            
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="ilu_institutecode">Add Institute
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                    <select name="ilu_institutecode" id="ilu_institutecode" class="select2_group form-control" required >
                                                    ...
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">Add Institute</span>
                                                </div>
                                            </div>
