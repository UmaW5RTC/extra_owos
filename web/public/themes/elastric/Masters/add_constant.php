...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Add Constant</strong></li>
</ol>
        ...
        <div class="neo-module-content">
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" required="required" class="form-control" placeholder="Constant Code" name="ict_constantcode">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Constant Name" name="ict_constantname" required="required" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Constant Code Prefix" name="ict_constantcodeprefix" required="required" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
