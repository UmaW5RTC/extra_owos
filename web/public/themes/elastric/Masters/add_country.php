    ...
    <div id="neo-contentbox-maincolumn">
        <div class="neo-module-content">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Country Code" name="icy_countrycode" required="required">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Country Name" name="icy_countryname" required="required" onkeydown="upperCaseF(this)">
                    <div class="form-control-focus"> </div>
