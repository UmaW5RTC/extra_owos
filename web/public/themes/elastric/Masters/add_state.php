...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Add State</strong></li>
</ol>
        ...
        <div class="neo-module-content">
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <div class="form-group form-md-line-input">
                    <label class="col-md-3 control-label" for="ist_countrycode">Country Name
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6">
                       <select name="ist_countrycode" id="ist_countrycode" class="select2_group form-control" required >
                ...
                <div class="form-group form-md-line-input">
                    <label class="col-md-3 control-label" for="ist_statecode">State Code
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="State Code" name="ist_statecode" required="required">
                ...
                <div class="form-group form-md-line-input">
                    <label class="col-md-3 control-label" for="ist_statename">State Name
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6">
                        <input type="text" class="form-control" placeholder="State Name" name="ist_statename" required="required" onkeydown="upperCaseF(this)">
                        <div class="form-control-focus"> </div>
                        <span class="help-block">State Name</span>
                    </div>                                              
                </div>                                          
                <div class="form-group form-md-line-input">
                    <label class="col-md-3 control-label" for="ist_institutecode">Institute Name
                        <span class="required">*</span>
                    </label>
                    <div class="col-md-6">
                       <select name="ist_institutecode" id="ist_institutecode" class="select2_group form-control" required >
                            <option value="" selected="selected">-- Select --</option>
                            <?php 
