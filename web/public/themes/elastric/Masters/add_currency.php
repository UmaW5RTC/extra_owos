...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Add Currency</strong></li>
</ol>
            ...
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" required="required" class="form-control" placeholder="Currency Code" name="icu_currencycode">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" required="required" class="form-control" placeholder="Currency Name"  name="icu_currencyname" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
                                                    <span class="help-block">Currency Name</span>
                                                </div>                                              
                                            </div>                                          
                                            <div class="form-group form-md-line-input">
                                                <label class="col-md-3 control-label" for="icu_institutecode">Institute Name
                                                    <span class="required">*</span>
                                                </label>
                                                <div class="col-md-6">
                                                   <select name="icu_institutecode" id="icu_institutecode" class="select2_group form-control" required >
