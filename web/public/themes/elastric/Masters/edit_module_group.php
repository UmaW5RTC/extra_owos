...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Edit module group</strong></li>
</ol>
        ...
        <div class="neo-module-content">
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegroupcode; ?>" placeholder="Module Group Code" name="imr_modulegroupcode">
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegroupname; ?>" placeholder="Module Group Name" name="imr_modulegroupname" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegroupname_hi; ?>" placeholder="Module Group Name Hindi" name="imr_modulegroupname_hi">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegroupname_or; ?>" placeholder="Module Group Name Odiya" name="imr_modulegroupname_or" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegroupiconname; ?>" placeholder="Module Group Icon Name" name="imr_modulegroupiconname" required="required">
                                                    <div class="form-control-focus"> </div>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" value="<?php echo $sel_modulegroup->imr_modulegrouporder; ?>" placeholder="Module Order" name="imr_modulegrouporder" onkeydown="upperCaseF(this)">
                                                    <div class="form-control-focus"> </div>
