...
<ol class="breadcrumb bc-2">
    ...
    <li class="active"><strong>Edit language</strong></li>
</ol>
            ...
            <form id="form" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
                ...
                <p><code>*</code> Marked Fields Are Compulsory</a></p>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Language Code" name="ilu_languagecode" value="<?php echo $sel_language->ilu_languagecode; ?>" readonly>
                                            ...
                                            <div class="form-group form-md-line-input">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="text" class="form-control" placeholder="Language Name" name="ilu_languagename" value="<?php echo $sel_language->ilu_languagename; ?>">
                                                    <div class="form-control-focus"> </div>
