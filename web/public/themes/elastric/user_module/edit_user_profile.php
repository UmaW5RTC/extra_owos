    ...
    <div id="neo-contentbox-maincolumn">
        <div class="neo-module-content">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Login Name" name="ius_loginid" id="ius_loginid" required="" value="<?php echo $sel_user->ius_loginid; ?>" readonly >
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="E-mail ID" name="ius_emailid" id="ius_emailid" required="" value="<?php echo $sel_user->ius_emailid; ?>" >
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="User Name" name="ius_username" id="ius_username" required="" value="<?php echo $sel_user->ius_username; ?>" >
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="password" class="form-control" placeholder="Password" name="ius_password" id="ius_password" required="" value="<?php echo $sel_user->ius_password; ?>" >
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="password" class="form-control" placeholder="Confirm Password" id="ius_c_password" required="" data-parsley-equalto="#ius_password" value="<?php echo $sel_user->ius_password; ?>"  >
                </div>
            </div>
                ...
                <div class="col-md-6">
                   <select name="ius_rolecode" id="ius_rolecode" class="select2_group form-control" required >
                    ...
                    <?php 
                        ...
                        if ($role->iro_rolecode == $sel_user->ius_rolecode) {
                            echo '<option value="' . $role->iro_rolecode . '" selected>' . $role->iro_rolename . '</option>';
                        }else{
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <p>
                    Suspended
                    <input type="radio" class="flat" name="ius_status" value="Suspended" 
                    <?php if($sel_user->ius_status == 'Suspended'){echo 'checked=""';}?> /> 
                    Active
                    <input type="radio" class="flat" name="ius_status" value="Active" 
                    <?php if($sel_user->ius_status == 'Active'){echo 'checked=""';}?> /> 
                    </p>
                </div>                                              
            </div>
