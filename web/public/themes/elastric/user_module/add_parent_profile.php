    ...
    <div id="neo-contentbox-maincolumn">
        <div class="neo-module-content">
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Parent Profile Code" name="ipr_parentprofcode" id="ipr_parentprofcode" required="">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <p>
                        Mr
                        <input type="radio" class="flat" name="ipr_title" value="Mr" checked="" required /> 
                        Mrs
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="First Name" name="ipr_name" id="ipr_name" required="">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Last Name" name="ipr_surname" id="ipr_surname">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Age" name="ipr_age" id="ipr_age" required="">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <p>
                        Male
                        <input type="radio" class="flat" name="ipr_sex" value="Male" checked="" required /> 
                        Female
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="date" class="form-control" name="ipr_dob" id="ipr_dob" required="">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <p>
                        Hindu
                        <input type="radio" class="flat" name="ipr_religion" value="Hindu" checked="" required /> 
                        Christian
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <textarea class="form-control" name="ipr_address" id="ipr_address"></textarea>
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="E-mail" name="ipr_emailid" id="ipr_emailid">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Mobile" name="ipr_mobile" id="ipr_mobile">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <input type="text" class="form-control" placeholder="Land Line" name="ipr_resno" id="ipr_resno">
                </div>
            </div>
            ...
            <div class="form-group form-md-line-input">
                ...
                <div class="col-md-6">
                    <textarea class="form-control" name="ipr_job" id="ipr_job" ></textarea>
                </div>
            </div>
