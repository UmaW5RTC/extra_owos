...
<div align="left"><p style="padding-left: 1cm;"><a href="<?php echo BASE;?>/user_module/add_user_profile" class="btn btn-success btn-xs">Add New</a></p></div>
    ...
    <div id="neo-contentbox-maincolumn">
        <div class="neo-module-content">
           <table class="table table-striped table-bordered table-hover" id="example">
                ...
                <?php $user_set = Im_Ur_User::find_all();?>

                <tbody>                                                
                    <?php foreach($user_set as $user): ?>
                    <tr>
                    <td><?php echo $user->ius_username; ?></td>
                    <td><?php echo $user->ius_emailid; ?></td>
                    <td><?php echo $user->ius_rolecode; ?></td>
                    <td>
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <a href="<?php echo BASE;?>/user_module/edit_user_profile/<?php echo $user->ius_userid; ?>">
                                <i class="icon-pencil"></i> Edit </a>
                            </li>
                            <li>
                                <a href="<?php echo BASE;?>/user_module/delete_user_profile/<?php echo $user->ius_userid; ?>" onclick="return confirm('Are you sure to delete the User - <?php echo $user->ius_userid; ?>?');">
